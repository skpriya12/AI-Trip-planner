...
Original file is located at
    https://colab.research.google.com/drive/1wOS2qLZJyr_qaCyHCKY8R7fBhBv9J5ZB
"""

!pip install crewai crewai-tools litellm gradio
...
def generate_itinerary(origin, destination, trip_duration, start_date):
    ...
    print("🔎 Raw CrewAI Result:", result)   # debug
...
with gr.Blocks() as demo:
    gr.Markdown("## 🧳 Travel Itinerary Planner with Airline Recommendations (LLM Only, Groq + CrewAI)")
    with gr.Row():
